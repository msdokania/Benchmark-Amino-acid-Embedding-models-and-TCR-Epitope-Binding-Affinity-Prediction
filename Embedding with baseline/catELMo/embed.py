...
model_dir = Path('/home/monalisadokania/catELMo')
...
dat = pd.read_csv('/home/monalisadokania/catELMo/datasets/BindingAffinityPrediction/TCREpitopePairs.csv')
dat['tcr_embeds'] = None
dat['epi_embeds'] = None
...
dat['epi_embeds'] = catELMo_embedding(list_of_lists_epi)
dat['tcr_embeds'] = catELMo_embedding(list_of_lists_tcr)

dat.to_pickle("/home/monalisadokania/catELMo/datasets/BindingAffinityPrediction/cat_embed.pkl")
